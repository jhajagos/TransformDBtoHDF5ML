...
if __name__ == "__main__":
    ...
    argparse_obj.add_argument("-f", "--hdf5-filename", "HDF5 file name for post processing", dest="hdf5_filename")
    argparse_obj.add_argument("-r", "--rules-json-filename", "JSON files with rules", dest="rules_json_filename")
